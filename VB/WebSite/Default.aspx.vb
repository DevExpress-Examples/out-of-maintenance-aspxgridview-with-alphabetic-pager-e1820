...
Partial Public Class _Default
	...
	Public Property ActivePageSymbol() As String
		Get
			...
			End If
			Return DirectCast(Session(sessionKey), String)
		End Get
...
'INSTANT VB NOTE: The variable activePageSymbol was renamed since Visual Basic does not handle local variables named the same as class members well:
		Public Sub New(ByVal activePageSymbol_Conflict As String)
			Me.activePageSymbol_Conflict = activePageSymbol_Conflict
		End Sub
